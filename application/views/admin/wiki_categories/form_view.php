...
$form_action = $is_edit ? site_url('admin/wiki_categories/edit/' . $category->category_id) : site_url('admin/wiki_categories/add');
?>
<div class="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
	<form action="<?php echo $form_action; ?>" method="post">
		...
		<div class="flex items-center space-x-4">
			...
			<a href="<?php echo site_url('admin/wiki_categories'); ?>" class="text-gray-500 bg-white hover:bg-gray-100 border border-gray-200 text-sm font-medium px-5 py-2.5 rounded-lg">Batal</a>
		</div>
	</form>
</div>
