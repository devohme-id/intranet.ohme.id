...
<div class="bg-white p-6 rounded-lg shadow-md">
	<div class="flex justify-between items-center mb-4">
		<h2 class="text-xl font-semibold">Daftar Kategori Wiki</h2>
		<a href="<?php echo site_url('admin/wiki_categories/add'); ?>" class="px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700">Tambah Kategori</a>
	</div>
			...
			<tbody>
				<?php foreach ($categories as $cat): ?>
					<tr class="bg-white border-b">
						...
						<td class="px-6 py-4"><?php echo $cat['article_count']; ?></td>
						<td class="px-6 py-4">
						...
						<td class="px-6 py-4 text-right">
							<a href="<?php echo site_url('admin/wiki_categories/edit/' . $cat['category_id']); ?>" class="font-medium text-blue-600 hover:underline mr-3">Edit</a>
							<a href="<?php echo site_url('admin/wiki_categories/delete/' . $cat['category_id']); ?>" onclick="return confirm('Anda yakin ingin menghapus kategori ini?')" class="font-medium text-red-600 hover:underline">Hapus</a>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
