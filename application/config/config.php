...
|
*/
$config['encryption_key'] = '1b1a66RM4LCNb5Yl6Ez7giP68apR7xV0z19wC20P';
...
$config['sess_cookie_name'] = 'ci_session_oneportal';
...
$config['csrf_token_name'] = 'csrf_token_portal';
$config['csrf_cookie_name'] = 'csrf_cookie_portal';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
$config['csrf_exclude_uris'] = array(); // e.g. 'api/controller/method'
